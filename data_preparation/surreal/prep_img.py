...
def generate_image(camera_idx, pkl_fp_idx, text_fp_idx, tgt_fp):
    '''
    render image given camera, pose and texture
    '''
    try:
        camera = cameras[camera_idx]
        pkl_fp = "../AGORA/"+poses[pkl_fp_idx]
...
agora = pd.read_csv("../AGORA/dataset/agora_dataframe.csv")
...
textures = os.listdir("./gen_texture")
